  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9 col-md-push-3">
        ...
        ?>
      <p  class="text-center"> Listings</p>
      </div>
      </div>
        ...
        $sql = "SELECT tblvehicles.* ,tblvehicles.Vimage1,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
